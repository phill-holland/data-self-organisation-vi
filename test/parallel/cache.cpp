...
{    
    ...
    organisation::genetic::cache::cache cache(parameters);
    cache.set(organisation::genetic::cache::xyzw(0,-1,-1), organisation::genetic::cache::xyzw(starting.x,18,starting.z,-4));
    ...
    std::vector<organisation::parallel::value> values0 = {
        { organisation::point( 10,18,10), organisation::point(0,-1,-1), 0, 0 }        
    };
